  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      await campaign.methods.contibute().send({
        from: accounts[0],
        value: web3.utils.toWei(getINRPriceToETH(data.value,ETHPrice), "ether"),
      });
          ...
          >
            <Stack spacing={{ base: 6 }}>
              ...
              <Link
                ...
                isExternal
              >
                View on Polygonscan Mumbai Network<ExternalLinkIcon mx="2px" />
              </Link>
              <Box mx={"auto"} w={"full"}>
                <SimpleGrid columns={{ base: 1 }} spacing={{ base: 5 }}>
                  <StatsCard
                    title={"Minimum Contribution"}
                    stat={`${getWEIPriceInINR(
                      ETHPrice,
                      minimumContribution
                    )} e₹`}
                    info={
                ...
                >
                  ...
                  <StatNumber>
                    ...
                    <Text fontSize={"md"} fontWeight="normal">
                      target of {" "}
                      {getWEIPriceInINR(ETHPrice, target)} e₹
                    </Text>
                    <Progress
                      colorScheme="blue"
                      size="sm"
                    ...
                    <FormControl id="value">
                      ...
                      <InputGroup>
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            setAmountInINR(Math.abs(e.target.value,ETHPrice));
                          }}
                          step="any"
                          min="0"
                        />{" "}
