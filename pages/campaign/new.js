...
import { getETHPrice, getETHPriceInINR,getINRPriceToETH } from "../../lib/getETHPrice";
  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      await factory.methods
        .createCampaign(
          web3.utils.toWei(getINRPriceToETH(data.minimumContribution,ETHPrice), "ether"),
          data.campaignName,
          data.description,
          data.imageUrl,
          web3.utils.toWei(getINRPriceToETH(data.target,ETHPrice), "ether")
        )
        .send({
          from: accounts[0],
        });
                ...
                <FormControl id="target">
                  ...
                  <InputGroup>
                    <Input
                      ...
                      isDisabled={isSubmitting}
                      onChange={(e) => {
                        setTargetInINR(Math.abs(e.target.value));
                      }}
                    />
                    <InputRightAddon children="e₹" />
                  </InputGroup>
